...
/// A [Column] with responsive spacing between its children.
///
...
class FlexifyColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: flexifyGapChildren(children, gap, Axis.vertical),
    );
  }
}
